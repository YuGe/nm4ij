...
public class NonmemSubroutineOptionParamImpl extends ASTWrapperPsiElement implements NonmemSubroutineOptionParam {

  public NonmemSubroutineOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSubroutineOptionParam(this);
  }
