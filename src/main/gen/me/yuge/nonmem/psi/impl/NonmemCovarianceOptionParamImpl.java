...
public class NonmemCovarianceOptionParamImpl extends ASTWrapperPsiElement implements NonmemCovarianceOptionParam {

  public NonmemCovarianceOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitCovarianceOptionParam(this);
  }
