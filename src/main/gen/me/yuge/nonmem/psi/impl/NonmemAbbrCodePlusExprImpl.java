...
public class NonmemAbbrCodePlusExprImpl extends ASTWrapperPsiElement implements NonmemAbbrCodePlusExpr {

  public NonmemAbbrCodePlusExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitAbbrCodePlusExpr(this);
  }
  ...
  @Override
  @NotNull
  public List<NonmemAbbrCodeMulExpr> getAbbrCodeMulExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, NonmemAbbrCodeMulExpr.class);
  }
