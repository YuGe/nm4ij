...
public class NonmemTableOptionParamImpl extends ASTWrapperPsiElement implements NonmemTableOptionParam {

  public NonmemTableOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitTableOptionParam(this);
  }
