...
public class NonmemEstimationOptionParamImpl extends ASTWrapperPsiElement implements NonmemEstimationOptionParam {

  public NonmemEstimationOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitEstimationOptionParam(this);
  }
