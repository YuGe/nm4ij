...
public class NonmemPkReservedParamImpl extends ASTWrapperPsiElement implements NonmemPkReservedParam {

  public NonmemPkReservedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitPkReservedParam(this);
  }
