...
public class NonmemOmegaIntParamImpl extends ASTWrapperPsiElement implements NonmemOmegaIntParam {

  public NonmemOmegaIntParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitOmegaIntParam(this);
  }
