...
public class NonmemSimulationSeedParamImpl extends ASTWrapperPsiElement implements NonmemSimulationSeedParam {

  public NonmemSimulationSeedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSimulationSeedParam(this);
  }
