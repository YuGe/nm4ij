...
public class NonmemAbbrCodeVariableImpl extends ASTWrapperPsiElement implements NonmemAbbrCodeVariable {

  public NonmemAbbrCodeVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitAbbrCodeVariable(this);
  }
