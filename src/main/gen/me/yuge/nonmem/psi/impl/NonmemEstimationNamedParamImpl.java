...
public class NonmemEstimationNamedParamImpl extends NonmemNamedParamImpl implements NonmemEstimationNamedParam {

  public NonmemEstimationNamedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitEstimationNamedParam(this);
  }
