...
public class NonmemSizesNamedParamImpl extends NonmemNamedParamImpl implements NonmemSizesNamedParam {

  public NonmemSizesNamedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSizesNamedParam(this);
  }
