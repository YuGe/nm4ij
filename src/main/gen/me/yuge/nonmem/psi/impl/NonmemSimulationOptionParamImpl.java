...
public class NonmemSimulationOptionParamImpl extends ASTWrapperPsiElement implements NonmemSimulationOptionParam {

  public NonmemSimulationOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSimulationOptionParam(this);
  }
