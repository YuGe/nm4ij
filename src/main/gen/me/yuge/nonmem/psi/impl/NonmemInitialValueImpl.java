...
public class NonmemInitialValueImpl extends ASTWrapperPsiElement implements NonmemInitialValue {

  public NonmemInitialValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitInitialValue(this);
  }
