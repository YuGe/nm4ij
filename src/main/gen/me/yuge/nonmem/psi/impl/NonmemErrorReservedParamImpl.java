...
public class NonmemErrorReservedParamImpl extends ASTWrapperPsiElement implements NonmemErrorReservedParam {

  public NonmemErrorReservedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitErrorReservedParam(this);
  }
