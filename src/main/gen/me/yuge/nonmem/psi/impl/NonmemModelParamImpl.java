...
public class NonmemModelParamImpl extends ASTWrapperPsiElement implements NonmemModelParam {

  public NonmemModelParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitModelParam(this);
  }
