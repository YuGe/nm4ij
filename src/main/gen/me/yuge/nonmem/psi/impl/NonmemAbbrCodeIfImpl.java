...
public class NonmemAbbrCodeIfImpl extends ASTWrapperPsiElement implements NonmemAbbrCodeIf {

  public NonmemAbbrCodeIfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitAbbrCodeIf(this);
  }
