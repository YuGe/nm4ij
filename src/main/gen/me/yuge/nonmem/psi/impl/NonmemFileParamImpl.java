...
public class NonmemFileParamImpl extends ASTWrapperPsiElement implements NonmemFileParam {

  public NonmemFileParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitFileParam(this);
  }
