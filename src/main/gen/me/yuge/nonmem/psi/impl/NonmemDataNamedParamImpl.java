...
public class NonmemDataNamedParamImpl extends NonmemNamedParamImpl implements NonmemDataNamedParam {

  public NonmemDataNamedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitDataNamedParam(this);
  }
