...
public class NonmemAbbrCodeFunctionImpl extends ASTWrapperPsiElement implements NonmemAbbrCodeFunction {

  public NonmemAbbrCodeFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitAbbrCodeFunction(this);
  }
