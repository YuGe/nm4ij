...
public class NonmemCovarianceNamedParamImpl extends NonmemNamedParamImpl implements NonmemCovarianceNamedParam {

  public NonmemCovarianceNamedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitCovarianceNamedParam(this);
  }
