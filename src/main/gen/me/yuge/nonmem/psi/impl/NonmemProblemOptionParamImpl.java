...
public class NonmemProblemOptionParamImpl extends ASTWrapperPsiElement implements NonmemProblemOptionParam {

  public NonmemProblemOptionParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitProblemOptionParam(this);
  }
