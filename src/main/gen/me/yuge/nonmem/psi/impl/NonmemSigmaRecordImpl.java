...
public class NonmemSigmaRecordImpl extends NonmemRecordImpl implements NonmemSigmaRecord {

  public NonmemSigmaRecordImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSigmaRecord(this);
  }
