...
public class NonmemAbbrCodeParenthesisImpl extends ASTWrapperPsiElement implements NonmemAbbrCodeParenthesis {

  public NonmemAbbrCodeParenthesisImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitAbbrCodeParenthesis(this);
  }
