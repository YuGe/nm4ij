...
public class NonmemSimulationNamedParamImpl extends NonmemNamedParamImpl implements NonmemSimulationNamedParam {

  public NonmemSimulationNamedParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull NonmemVisitor visitor) {
    visitor.visitSimulationNamedParam(this);
  }
